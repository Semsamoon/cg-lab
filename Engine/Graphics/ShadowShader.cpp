...
void ShadowShader::Compose(DXDevice* device, DXDeviceContext* context, const char16* file_path)
{
...
void ShadowShader::Destroy() const
{
    ...
    DXShaderResourceView* texture)
{
    ...
    transform_buffer_.data.world_view_proj = world * view_projection;
